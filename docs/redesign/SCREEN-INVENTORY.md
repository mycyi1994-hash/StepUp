...
|---|---|---|---|---|
| Screen.Run.route | Run | Main | character-free native layout implemented; see CHARACTER-FREE-STAGE2-2026-09-25-KO.md | design/string/media source checks passed; Android compile, device captures and interaction validation pending stages 3–4 |
| Routes.MYSTERY_BOX | Customize | Main | character-free native layout implemented; see CHARACTER-FREE-STAGE2-2026-09-25-KO.md | design/string/media source checks passed; Android compile, device captures and interaction validation pending stages 3–4 |
| Screen.Customize.route | Customize | Main | character-free native layout implemented; see CHARACTER-FREE-STAGE2-2026-09-25-KO.md | design/string/media source checks passed; Android compile, device captures and interaction validation pending stages 3–4 |
...
| Screen.Community.route | Community | Main | character-free native layout implemented; see CHARACTER-FREE-STAGE2-2026-09-25-KO.md | design/string/media source checks passed; Android compile, device captures and interaction validation pending stages 3–4 |
...
| Routes.EVENTS | Run | Detail | character-free native layout implemented; see CHARACTER-FREE-STAGE2-2026-09-25-KO.md | design/string/media source checks passed; Android compile, device captures and interaction validation pending stages 3–4 |
| Screen.Profile.route | Profile | Main | character-free native layout implemented; see CHARACTER-FREE-STAGE2-2026-09-25-KO.md | design/string/media source checks passed; Android compile, device captures and interaction validation pending stages 3–4 |
| Routes.RUN_ROUTE | Run | Focus | character-free native layout implemented; see CHARACTER-FREE-STAGE2-2026-09-25-KO.md | design/string/media source checks passed; Android compile, device captures and interaction validation pending stages 3–4 |
...
|---|---|---|---|
| CommunityScreen | app/src/main/java/com/stepup/android/ui/screens/community/CommunityScreen.kt:86 | character-free native layout implemented; see CHARACTER-FREE-STAGE2-2026-09-25-KO.md | design/string/media source checks passed; Android compile, device captures and interaction validation pending stages 3–4 |
...
| CrewCreateScreen | app/src/main/java/com/stepup/android/ui/screens/community/CrewCreateScreen.kt:40 | stage 7-9 source finish; see DESIGN-FINISH-2026-09-24-KO.md | source checks only; Android compile/capture pending |
...
| PostComposeScreen | app/src/main/java/com/stepup/android/ui/screens/community/PostComposeScreen.kt:42 | stage 7-9 source finish; see DESIGN-FINISH-2026-09-24-KO.md | source checks only; Android compile/capture pending |
...
| CustomizeScreen | app/src/main/java/com/stepup/android/ui/screens/customize/CustomizeScreen.kt:40 | character-free native layout implemented; see CHARACTER-FREE-STAGE2-2026-09-25-KO.md | design/string/media source checks passed; Android compile, device captures and interaction validation pending stages 3–4 |
...
| EventsScreen | app/src/main/java/com/stepup/android/ui/screens/events/EventsScreen.kt:81 | character-free native layout implemented; see CHARACTER-FREE-STAGE2-2026-09-25-KO.md | design/string/media source checks passed; Android compile, device captures and interaction validation pending stages 3–4 |
...
| MysteryBoxScreen | app/src/main/java/com/stepup/android/ui/screens/gacha/MysteryBoxScreen.kt:48 | character-free native layout implemented; see CHARACTER-FREE-STAGE2-2026-09-25-KO.md | design/string/media source checks passed; Android compile, device captures and interaction validation pending stages 3–4 |
| HomeScreen | app/src/main/java/com/stepup/android/ui/screens/home/HomeScreen.kt:85 | character-free native layout implemented; see CHARACTER-FREE-STAGE2-2026-09-25-KO.md | design/string/media source checks passed; Android compile, device captures and interaction validation pending stages 3–4 |
...
| LoginScreen | app/src/main/java/com/stepup/android/ui/screens/login/LoginScreen.kt:68 | character-free native layout implemented; see CHARACTER-FREE-STAGE2-2026-09-25-KO.md | design/string/media source checks passed; Android compile, device captures and interaction validation pending stages 3–4 |
...
| ProfileScreen | app/src/main/java/com/stepup/android/ui/screens/profile/ProfileScreen.kt:131 | character-free native layout implemented; see CHARACTER-FREE-STAGE2-2026-09-25-KO.md | design/string/media source checks passed; Android compile, device captures and interaction validation pending stages 3–4 |
...
| RunScreen | app/src/main/java/com/stepup/android/ui/screens/walk/WalkScreen.kt:135 | character-free native layout implemented; see CHARACTER-FREE-STAGE2-2026-09-25-KO.md | design/string/media source checks passed; Android compile, device captures and interaction validation pending stages 3–4 |
